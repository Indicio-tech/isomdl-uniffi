...
This project incorporates code and concepts from the following open-source projects developed by Spruce Systems, Inc. We are grateful for their contributions to the open-source community.
...
We thank Spruce Systems, Inc. and the contributors to both the `isomdl` and `sprucekit-mobile` projects for their foundational work in the digital identity and mobile driver's license space. Their open-source contributions have made this project possible.

For more information about Spruce Systems, Inc. and their work, visit: https://spruceid.com/
