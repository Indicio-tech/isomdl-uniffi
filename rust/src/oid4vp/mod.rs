...
use isomdl::{
    ...
    definitions::{
        DeviceAuth, DeviceResponse, DeviceSigned, Document, IssuerSigned, device_response::Status, device_signed::{DeviceAuthentication, DeviceNamespaces}, helpers::{NonEmptyVec, Tag24}, issuer_signed::IssuerSignedItemBytes, traits::ToCbor
    },
};
...
impl MDocOid4vpSession {
    ...
    pub fn build_device_response(
        ...
        let transcript: OID4VPSessionTranscript =
            serde_json::from_str(&session_transcript)
